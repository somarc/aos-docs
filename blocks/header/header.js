...
import { createSearchTrigger } from '../../scripts/search.js';
...
function decorateSearch(actions) {
  if (!actions || actions.querySelector('.site-search-trigger')) return;
  const search = document.createElement('div');
  search.id = 'search';
  actions.prepend(search);
  createSearchTrigger(search);
}
